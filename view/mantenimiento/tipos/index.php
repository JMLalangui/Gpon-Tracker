...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1 class="m-0">Listado de tipos de equipos</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                        ...
                        <div class="card-body table-responsive" >
                            <table id="table_datos" class="table table-bordered table-striped table-hover">
                                <thead class="thead-dark">
                                    <tr>
                                        <th scope="col">N°</th>
                                        <th scope="col">Tipos de equipos</th>
                                ...
                                <tbody>
                                    <?php
                                    $cont = 0;
                                    foreach ($bd_tipos as $bd_tip){ 
                                      $idTipos = $bd_tip['id_ti'];
                                      ?>
                                        <tr>
                                            <td><?php echo $cont+=1;?></td>
                                            <td><?php echo $bd_tip['tipo_ti']?></td>
                                            <td>
                                              <center>
                                                <div class="btn-group">
