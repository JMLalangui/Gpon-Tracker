...
include ("../../../app/controllers/mantenimiento/estados/listar.php"); 
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1 class="m-0">Listado de estados</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                        ...
                        <div class="card-body table-responsive" >
                            <table id="table_datos" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $cont = 0;
                                    foreach ($bd_estados as $bd_est){ 
                                      $idEstado = $bd_est['id_est'];
                                      ?>
                                        <tr>
                                            <td><?php echo $cont+=1;?></td>
                                            <td><?php echo $bd_est['estado_est']?></td>
                                            <td>
                                              <center>
                                                <div class="btn-group">
