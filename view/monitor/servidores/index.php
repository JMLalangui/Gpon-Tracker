...
<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1 class="m-0">Listado de servidores</h1>
          </div>
        </div>
      </div>
    </div>
...
<script>
  function actualizarServidores() {
    $.ajax({
      url: '../ajax/actualizarServidores.php',  // La ruta al archivo PHP que devuelve el contenido
      method: 'GET',
      success: function(response) {
        // Actualizamos el contenido del div con el listado de servidores
        $('#servidores-list').html(response);
      },
      error: function() {
        console.log("Error al obtener los servidores.");
      }
    });
  }
